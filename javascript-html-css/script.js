...
function subtrair(){
    ...
    var c = document.getElementById("resDiv")
    if(resSub => 0){
        c.style.color = "green"
        positivoS.style.display = "block"
        positivoS.style.color = "green"
        negativoS.style = "none"
    }
    else{
        c.style.color = "red"
        negativoS.style.display = "block"
        negativoS.style.color = "red"
        positivoS.style = "none"
    }
